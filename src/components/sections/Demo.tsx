    ...
    <section className="py-20 bg-slate-900 text-white">
      <div className="max-w-7xl mx-auto px-4 md:px-8">
        <div className="text-center mb-12 animate-fade-in-up">
          <h2 className="text-3xl md:text-4xl font-bold mb-4 uppercase">Demo Buổi Đào Tạo</h2>
          <p className="text-slate-400 text-lg">Trải nghiệm thực tế không khí học tập và giảng dạy</p>
        </div>
        ...
        <div className="max-w-4xl mx-auto relative group cursor-pointer animate-scale-in">
          ...
          <div className="relative aspect-video bg-slate-800 rounded-2xl overflow-hidden border border-slate-700 shadow-2xl flex items-center justify-center">
            ...
            <div className="z-20 text-center">
              ...
              <p className="text-slate-300 font-medium uppercase tracking-widest text-sm">Xem Video Demo</p>
            </div>
